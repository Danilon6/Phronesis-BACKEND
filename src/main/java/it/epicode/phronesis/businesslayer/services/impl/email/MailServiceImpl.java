        ...
        try {
            ...
            String emailContent =
                    "<head>" +
                            ...
                            + "</ul>"
                            + "<p style='font-size: 14px;'>To get started, verify your profile through this <a href=http://localhost:4200/auth/enable?k=" + token + ">link</a>" + " then log in to your account and begin exploring the diverse experiences shared by our community members. Every story you read and share contributes to a more empathetic and understanding world. 🌍</p>"
                            ...
                            + "<p style='font-size: 14px;'> If your link is expired request <a href='" + "http://localhost:4200/auth/request-new-verification-link?e=" + user.getEmail()+ "'>a new verification link</a></p>"
    ...
    public void sendMailNewVerificationLink(User user, String token) throws EmailSendingException, UnsupportedEmailEncodingException {
        ...
        try {
            ...
            String emailContent = "<html>"
                    ...
                    + "<p style='font-size: 14px;'><a href=http://localhost:4200/auth/enable?k=" + token + ">Verifica il tuo account</a></p>"
